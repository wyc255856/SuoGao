...
public class JuBenFragment extends BaseListFragment {
	...
	protected void initAction() {
		// TODO Auto-generated method stub
		super.initAction();
		adapter.refresh(help.getTabMenuModel().getDataList());
	}
	@Override
	protected String getTitleText() {
		// TODO Auto-generated method stub
		return getString(R.string.title_juben);
	}
	...
	protected View initView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		return inflater.inflate(R.layout.fragment_juben, container,
				false);
	}
