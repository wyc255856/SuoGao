...
public class ZhuChuangFragment extends BaseListFragment {
	...
	protected void initAction() {
		// TODO Auto-generated method stub
		super.initAction();
		adapter.refresh(help.getTabMenuModel().getZcList());
	}
	@Override
	protected String getTitleText() {
		// TODO Auto-generated method stub
		return getString(R.string.title_zhuchuang);
	}
	...
	protected View initView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		return inflater.inflate(R.layout.fragment_zhuchuang, container,
				false);
	}
