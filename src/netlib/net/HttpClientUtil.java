...
//		String cookieStr = LoginUtil.getCookie(context);
//		if (cookieStr != null && !cookieStr.equals("")) {
//			String[] co = cookieStr.split("####");
//			if (co.length > 0) {
...
//						cookie.setComment(c[2]);
//						cookie.setDomain(c[3]);
//						cookie.setPath(c[4]);
//						cookie.setVersion(Integer.valueOf(c[5]));
//						Log.d("sendCookie", "发送的cookie = "+cookie.toString());
//						cookieStore.addCookie(cookie);
//					}
//				}
//				localContext.setAttribute(ClientContext.COOKIE_STORE, cookieStore);
//			}
//			Log.d("sendCookie", "发送的cookieStr = "+cookieStr);
...
//				}
				...
				getCookie(context, client, response);
...
//	}
	...
	private static void getCookie(Context context, DefaultHttpClient httpClient, HttpResponse response) {
		
		String value = null;
		Header header = response.getFirstHeader("Set-Cookie");
		if (header != null) {
			value = header.getValue();
			Log.d("cookie", "收到的cookies  value = "+value);
//			LoginUtil.setCookie(context, value);
		}
...
//			Cookie cookie = cookies.get(i);
//			Log.d("cookie", "收到的cookie = "+cookie.toString());
//			sb.append(cookie.getName() + "~~~~" + value == null?cookie.getValue() : value + "~~~~" + cookie.getComment() + "~~~~"
//					+ cookie.getDomain() + "~~~~" + cookie.getPath() + "~~~~" + cookie.getVersion() + "####");
//			
//		}
//		if (sb.length() > 0) {
