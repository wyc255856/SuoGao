...
import com.suogao.suogao_android.util.ResourceUtil;
...
public class UpdateOSServiceHelper {
	...
	/* 下载包安装路径 */
	private static final String savePath = Environment.getExternalStorageDirectory() + "/suogao/";
